// https://github.com/janaagaard75/expo-type-definitions/blob/master/index.d.ts
// https://github.com/airbnb/react-native-maps/pull/1687
...
declare module 'expo' {
    ...
    export interface MapViewEvent extends NativeSyntheticEvent<NativeTouchEvent & { coordinate: MapCoordinate; }> { }

    type MapViewFunction = (e: MapViewEvent) => any;
    ...
    interface MapViewProps {
        ...
        onChange?: MapViewFunction;
        onMapReady?: MapViewFunction;
        onRegionChange?: MapViewFunction;
        onRegionChangeComplete?: MapViewFunction;
        onPress?: MapViewFunction;
        onLayout?: MapViewFunction;
        onLongPress?: MapViewFunction;
        onPanDrag?: MapViewFunction;
        onMarkerPress?: MapViewFunction;
        onMarkerSelect?: MapViewFunction;
        onMarkerDeselect?: MapViewFunction;
        onCalloutPress?: MapViewFunction;
        onMarkerDragStart?: MapViewFunction;
        onMarkerDrag?: MapViewFunction;
        onMarkerDragEnd?: MapViewFunction;
        minZoomLevel?: number;
        maxZoomLevel?: number;
    }
    ...
    export namespace MapView {
        ...
        interface MarkerProps {
            ...
            centerOffset?: MapPoint;
            calloutOffset?: MapPoint;
            anchor?: MapPoint;
            calloutAnchor?: MapPoint;
            flat?: boolean;
            draggable?: boolean;
            onPress?: MapViewFunction;
            onSelect?: MapViewFunction;
            onDeselect?: MapViewFunction;
            onCalloutPress?: MapViewFunction;
            onDragStart?: MapViewFunction;
            onDrag?: MapViewFunction;
            onDragEnd?: MapViewFunction;
            zIndex?: number;
        }
